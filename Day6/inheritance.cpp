...
// 2)If derived class uses private accessibility mode then public data & member function of the class will become private
// 3)If derived class uses public accessibility mode then public data & member function of the class will become public

// class child : parent // Derived class  (by default private)
//  class child : private Parent{ // Derived class  (private)
...
int main(){
    ...
    cout << "Enter yous family name, family head, number of members & net worth:";
