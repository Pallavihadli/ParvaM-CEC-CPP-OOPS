...
class Bike : public Vehicle{ // Derived class can access the data & member functions of the base class(via public)
    private:
       string brand;
...
int main(){
    ...
    bike1.setMode(mode_of_transport); // Accessing the member function of Base Class(Inheritating the properties)
    bike1.setMode(brand_name);
