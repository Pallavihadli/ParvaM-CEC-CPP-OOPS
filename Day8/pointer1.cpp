...
int main(){
    int age;
    int *ptrAge = &age; // address of age(Pointer reference)
    ...
    cout << "The address of name is stroed in pointer(nameptr):" << namePtr << endl;
    cout << "The address of age is stroed in pointer(ptrAge):" << ptrAge << endl;
    ...
    for(int i=0; i < size; i++){
     ...
     cout << "The arry contains " << size << " elements, They are:" << endl;
     for(int i=0; i < size; i++){
        cout << arr[i] << endl;
    }
}